...
public class Stream {
	...
	public static void main(String[] args) {
		...
		// Display Total Employee and display each employee
		int count=(int)emp.stream().count();
		emp.stream()
			.forEach(e -> System.out.println("Name : "+e.getName()+", Age : "+e.getAge()));
		System.out.println("Total employees : "+count+"\n\n");
		
		// Display filterd employee whose age > 23 and display them
		...
		// Display employee in ASC ordered
		System.out.println("\nEmployee sorted by age (ASC) : ");
		emp.stream()
			.sorted((e1,e2) -> e1.getAge()-e2.getAge())
			.forEach(e -> System.out.println("Name : "+e.getName()+", Age : "+e.getAge()));
		
		// Display employee in DESC ordered
		System.out.println("\nEmployee sorted by age (DESC) : ");
		emp.stream()
			.sorted((e1,e2) -> e2.getAge()-e1.getAge())
			.forEach(e -> System.out.println("Name : "+e.getName()+", Age : "+e.getAge()));
		
		// Display employee age collection
		emp.stream()
			.sorted((e1,e2) -> e1.getAge()-e2.getAge())
